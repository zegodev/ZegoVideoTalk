...
#define IPAD_PRO_129_2ND @"iPad PRO 12.9 2nd"
...
@property (nonatomic, readonly) NSArray *videoCodecTypeList;        // 分层编码列表
@property (nonatomic, assign) NSInteger videoCodecType;             // 当前使用的分层编码类型
